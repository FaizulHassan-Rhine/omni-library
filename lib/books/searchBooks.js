...
const FALLBACK_GUTENBERG = [
  { id: 1342, title: "Pride and Prejudice", authors: [{ name: "Jane Austen" }], languages: ["en"], download_count: 57000 },
  { id: 84, title: "Frankenstein", authors: [{ name: "Mary Wollstonecraft Shelley" }], languages: ["en"], download_count: 22000 },
  { id: 11, title: "Alice's Adventures in Wonderland", authors: [{ name: "Lewis Carroll" }], languages: ["en"], download_count: 21000 },
  { id: 1661, title: "The Adventures of Sherlock Holmes", authors: [{ name: "Arthur Conan Doyle" }], languages: ["en"], download_count: 19000 },
  { id: 98, title: "A Tale of Two Cities", authors: [{ name: "Charles Dickens" }], languages: ["en"], download_count: 18000 },
  { id: 174, title: "The Picture of Dorian Gray", authors: [{ name: "Oscar Wilde" }], languages: ["en"], download_count: 17000 },
  { id: 345, title: "Dracula", authors: [{ name: "Bram Stoker" }], languages: ["en"], download_count: 16000 },
  { id: 1260, title: "Jane Eyre", authors: [{ name: "Charlotte Brontë" }], languages: ["en"], download_count: 15000 },
  { id: 76, title: "Adventures of Huckleberry Finn", authors: [{ name: "Mark Twain" }], languages: ["en"], download_count: 14000 },
  { id: 2701, title: "Moby Dick", authors: [{ name: "Herman Melville" }], languages: ["en"], download_count: 13000 },
  { id: 46, title: "A Christmas Carol", authors: [{ name: "Charles Dickens" }], languages: ["en"], download_count: 12000 },
  { id: 1400, title: "Great Expectations", authors: [{ name: "Charles Dickens" }], languages: ["en"], download_count: 11000 },
];
...
export async function getFreeBooks({ language = "", page = 1 } = {}) {
  ...
  const [ol, gutenberg] = await Promise.all([olPromise, gutendexPromise]);
  ...
  if (!books.length && !lang && page === 1) {
    books = FALLBACK_GUTENBERG.map(normalizeGutendexBook).filter(Boolean);
  }
  ...
  return {
    books,
    count: Math.max(gutenberg.count || 0, ol.numFound || 0, books.length),
    page,
    pageSize,
  };
}
